    ...
    sections: [
      {
        questions: [
          ...
          },
          {
            ...
            ar: "",
            labels: [
              { label: { en: "More so than usual", ar: "", value: 1 } },
              { label: { en: "Same as usual", ar: "", value: 2 } },
              { label: { en: "Less so than usual", ar: "", value: 3 } },
              { label: { en: "Much more than usual", ar: "", value: 4 } },
            ],
          },
          {
            ...
            ar: "",
            labels: [
              { label: { en: "Quicker than usual", ar: "", value: 1 } },
              { label: { en: "Same as usual", ar: "", value: 2 } },
              { label: { en: "Longer than usual", ar: "", value: 3 } },
              { label: { en: "Much longer than usual", ar: "", value: 4 } },
            ],
          },
          {
            en: "Have you recently felt on the whole youwere doing things well?",
            ar: "",
            labels: [
              { label: { en: "Better than usual", ar: "", value: 1 } },
              { label: { en: "About the same", ar: "", value: 2 } },
              { label: { en: "Less well than usual", ar: "", value: 3 } },
              { label: { en: "Much less well", ar: "", value: 4 } },
            ],
          },
          {
            en: "Have you recently been satisfied with the wayyou've carried out your task?",
            ar: "",
            labels: [
              { label: { en: "More satisfied", ar: "", value: 1 } },
              { label: { en: "About same as usual", ar: "", value: 2 } },
              { label: { en: "Less satisfied than usual", ar: "", value: 3 } },
              { label: { en: "Much less satisfied", ar: "", value: 4 } },
            ],
          },
          {
            en: "Have you recently felt that you are playinga useful part in things?",
            ar: "",
            labels: [
              { label: { en: "More so than usual", ar: "", value: 1 } },
              { label: { en: "Same as usual", ar: "", value: 2 } },
          ...
          {
            en: "Have you recently been able to enjoy yournormal day-to-day activities?",
            ar: "",
            labels: [
              { label: { en: "More so than usual", ar: "", value: 1 } },
              { label: { en: "Same as usual", ar: "", value: 2 } },
          ...
          {
            en: "Have you recently been getting edgy andbad-tempered?",
            ar: "",
            labels: [
              { label: { en: "Not at all", ar: "", value: 1 } },
              { label: { en: "No more than usual", ar: "", value: 2 } },
          ...
          {
            en: "Have you recently found everything gettingon top of you?",
            ar: "",
            labels: [
              { label: { en: "Not at all", ar: "", value: 1 } },
              { label: { en: "No more than usual", ar: "", value: 2 } },
          ...
          {
            en: "Have you recently been thinking of yourselfas a worthless person?",
            ar: "",
            labels: [
              { label: { en: "Not at all", ar: "", value: 1 } },
              { label: { en: "No more than usual", ar: "", value: 2 } },
          ...
          {
            en: "Have you recently felt that life is entirelyhopeless?",
            ar: "",
            labels: [
              { label: { en: "Not at all", ar: "", value: 1 } },
              { label: { en: "No more than usual", ar: "", value: 2 } },
          ...
          },
          {
            ...
            ar: "",
            labels: [
              { label: { en: "Definitly not", ar: "", value: 1 } },
              { label: { en: "I don't think so", ar: "", value: 2 } },
              { label: { en: "Has crossed my mind", ar: "", value: 3 } },
              { label: { en: "Definitely has", ar: "", value: 4 } },
            ],
          },
          {
