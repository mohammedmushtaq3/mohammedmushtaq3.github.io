...
(function(window) {
    ...
    MLMenu.prototype._init = function() {
        ...
        if( self.options.breadcrumbsCtrl ) {
            ...
            document.getElementById("menu__crumbs").appendChild(this.breadcrumbsCtrl);
        ...
        if (this.options.backCtrl) {
            ...
            if (this.breadCrumbs) {
                ...
                $('#menu__crumbs').removeClass('root');
            } else {
                this.backCtrl.className = 'menu__back menu__back--hidden';
                $('#menu__crumbs').addClass('root');
            }
            this.backCtrl.setAttribute('aria-label', 'Go back');
            this.backCtrl.innerHTML = '<span class="demo-icon icon-back-arrow"></span>';
            //this.el.insertBefore(this.backCtrl, this.breadcrumbsCtrl);
            document.getElementById("menu__crumbs").appendChild(this.backCtrl);
            //this.el.firstChild
        }
